            ...
            {member.image ? (
              <a href={member.github} target="_blank" rel="noopener noreferrer">
                <img
                  src={member.image}
                  alt={member.name}
                  className="w-24 h-24 mx-auto rounded-full shadow-lg mb-4 object-cover hover:scale-105 transition-transform duration-200"
                />
              </a>
            ) : (
